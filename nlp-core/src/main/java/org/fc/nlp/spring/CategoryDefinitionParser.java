 ...
 * @version $Revision: 39 $
 * $Id: CategoryDefinitionParser.java 39 2010-02-23 09:43:47Z fredcons $
 */
public class CategoryDefinitionParser extends AbstractSingleBeanDefinitionParser {
    ...
    protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        builder.addPropertyValue("documents", parsedList);
    }    
