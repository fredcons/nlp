...
import org.fc.nlp.web.support.xstream.CategorizationConverter;
import org.fc.nlp.web.support.xstream.CategorizationResponseConverter;
import org.fc.nlp.web.support.xstream.ExplainResponseConverter;
import org.fc.nlp.web.support.xstream.GaeXStream;
import org.fc.nlp.web.support.xstream.ResponseMetadataConverter;
import org.fc.nlp.web.support.xstream.TextExtractionResponseConverter;
...
public class GaeXStreamMarshaller extends AbstractMarshaller implements InitializingBean, BeanClassLoaderAware {
	...
	private final GaeXStream xstream = new GaeXStream();
	 ...
	 */
	protected void customizeXStream(GaeXStream xstream) {
		xstream.registerConverter(new CategorizationConverter());
		xstream.registerConverter(new ExplainResponseConverter());
		xstream.registerConverter(new ResponseMetadataConverter());
		xstream.registerConverter(new CategorizationResponseConverter());
		xstream.registerConverter(new TextExtractionResponseConverter());
		xstream.alias("categorization", Categorization.class);
		xstream.alias("explainResponse", ExplainResponse.class);
		xstream.alias("categorizationResponse", CategorizationResponse.class);
